...
from random import *
font.init()
paintFont = font.SysFont("Times New Roman", 20) #Font used to give the coordinates of the mouse on the canvas
omx,omy = mx,my = (0,0)
...
def getName():
    ...
    tnrFont = font.SysFont("Times New Roman", 16)
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~CANVAS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    if canvasRect.collidepoint(mx,my):
        ...
        #SPRAY CAN
        if sel_Tool == 6:           
            #xpos and ypos are points offset from mx,my
            if mb[0] == 1:
        ...
        if sel_Tool == 8:
            ...
            if mb[0] == 1:
                ...
                if mx > omx:
                    if shapestyle == 1:
                        ...
                        draw.line(screen,sel_Colour1,(omx - width / 2 + x,omy),(mx + width / 2,omy),width)
                        draw.line(screen,sel_Colour1,(omx - width / 2 + x,my),(mx + width / 2,my),width)
                ...
                if mx < omx:
                    if shapestyle == 1:
                        draw.line(screen,sel_Colour1,(omx,omy),(omx,my),width)
                        draw.line(screen,sel_Colour1,(omx + width / 2,omy),(mx - width / 2 - x,omy),width)
                        draw.line(screen,sel_Colour1,(omx + width / 2,my),(mx - width / 2 - x,my),width)
                        draw.line(screen,sel_Colour1,(mx,omy),(mx,my),width)
                    if shapestyle == 2:
                        draw.rect(screen,sel_Colour1,(omx,omy,mx - omx,my - omy))
                    if shapestyle == 3:
                        draw.rect(screen,sel_Colour2,(omx,omy,mx - omx,my - omy))
                        draw.line(screen,sel_Colour1,(omx,omy),(omx,my),width)
                        draw.line(screen,sel_Colour1,(omx,omy),(mx,omy),width)
                        draw.line(screen,sel_Colour1,(omx,my),(mx,my),width)
                        draw.line(screen,sel_Colour1,(mx,omy),(mx,my),width)
            ...
            if mb[2] == 1:
                ...
                if shapestyle == 1:
                    ...
                    draw.line(screen,sel_Colour2,(omx - width / 2 + x,omy),(mx + width / 2,omy),width)
                    draw.line(screen,sel_Colour2,(omx - width / 2 + x,my),(mx + width / 2,my),width)
